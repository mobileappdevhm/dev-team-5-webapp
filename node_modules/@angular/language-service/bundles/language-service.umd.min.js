 ...
 * found in the LICENSE file at https://angular.io/license
 */
var Dp=function tt(t){this.full=t,this.major=t.split(".")[0],this.minor=t.split(".")[1],this.patch=t.split(".").slice(2).join(".")},jp=new Dp("6.0.1"),Lp="ngDebugContext",Fp="ngOriginalError",Vp="ngErrorLogger";function Hp(t){return t[Lp]}function Bp(t){return t[Fp]}function qp(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n];t.error.apply(t,c(e))}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
